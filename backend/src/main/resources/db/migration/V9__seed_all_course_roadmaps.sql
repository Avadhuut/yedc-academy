-- Seed Sections for Course 3 (Financial Modelling / Food Processing) safely using ON CONFLICT DO NOTHING
INSERT INTO section (course_id, title, display_order) 
VALUES
(3, 'Module 1: Unit Economics & Capital Sizing', 1),
(3, 'Module 2: Machinery Procurement & Cost Structure', 2),
(3, 'Module 3: FSSAI Licensing & B2B Distribution', 3)
...
-- Seed Sections for Course 4
INSERT INTO section (course_id, title, display_order) VALUES
(4, 'Module 1: Viral Growth Engines & Experimentation', 1),
(4, 'Module 2: Programmatic SEO & PLG Systems', 2)
ON CONFLICT DO NOTHING;
...
-- Seed Sections for Course 5
INSERT INTO section (course_id, title, display_order) VALUES
(5, 'Module 1: Snack Production & Packaging Mechanics', 1),
(5, 'Module 2: Distributor Margin Structuring', 2)
ON CONFLICT DO NOTHING;
